...
// v1.10: unified mega-mix block injected into EVERY trainer monSet so
// every facility/trainer-class has a chance to roll modern mons. Fixes
// the "rarely see new pokemon in all facilities" complaint. Combines
// fodder + pre-evos + competitive + legendaries + Z-moves.
#define FRONTIER_MONS_MEGA_MIX_BLOCK    \
    FRONTIER_MONS_MODERN_FODDER_BLOCK,  \
    FRONTIER_MONS_V19_EXPANSION_BLOCK,  \
    FRONTIER_MONS_MODERN_META_BLOCK,    \
    FRONTIER_MONS_LEGENDARY_BLOCK,      \
