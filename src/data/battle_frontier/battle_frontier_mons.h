const struct TrainerMon gBattleFrontierMons[NUM_FRONTIER_MONS] =
{
    ...
    // -- v1.8: Modern competitive sets (Smogon-inspired, Gen 4-9) --
    ...
    [FRONTIER_MON_GARCHOMP_3] = {
        .species = SPECIES_GARCHOMP,
        .moves = {MOVE_EARTHQUAKE, MOVE_DRACO_METEOR, MOVE_FIRE_BLAST, MOVE_STONE_EDGE},
    ...
    [FRONTIER_MON_METAGROSS_M1] = {
        .species = SPECIES_METAGROSS,
        .moves = {MOVE_METEOR_MASH, MOVE_BULLET_PUNCH, MOVE_EARTHQUAKE, MOVE_STEALTH_ROCK},
        .heldItem = ITEM_LEFTOVERS,
    ...
    [FRONTIER_MON_SCIZOR_M1] = {
        .species = SPECIES_SCIZOR,
        .moves = {MOVE_SWORDS_DANCE, MOVE_BULLET_PUNCH, MOVE_BUG_BITE, MOVE_KNOCK_OFF},
        .heldItem = ITEM_LIFE_ORB,
    ...
    [FRONTIER_MON_LUCARIO_M1] = {
        ...
        .moves = {MOVE_CLOSE_COMBAT, MOVE_METEOR_MASH, MOVE_EXTREME_SPEED, MOVE_BULLET_PUNCH},
    ...
    [FRONTIER_MON_HEATRAN_1] = {
        ...
        .moves = {MOVE_MAGMA_STORM, MOVE_EARTH_POWER, MOVE_FLASH_CANNON, MOVE_FIRE_BLAST},
        .heldItem = ITEM_CHOICE_SPECS,
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 4),
    ...
    [FRONTIER_MON_HEATRAN_2] = {
        .species = SPECIES_HEATRAN,
        .moves = {MOVE_STEALTH_ROCK, MOVE_MAGMA_STORM, MOVE_EARTH_POWER, MOVE_TAUNT},
    ...
    [FRONTIER_MON_LATIOS_M1] = {
        .species = SPECIES_LATIOS,
        .moves = {MOVE_DRACO_METEOR, MOVE_PSYSHOCK, MOVE_AURA_SPHERE, MOVE_TRICK},
        .heldItem = ITEM_CHOICE_SPECS,
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 4),
        .ability = ABILITY_LEVITATE,
        .nature = NATURE_TIMID,
    ...
    [FRONTIER_MON_LATIAS_M1] = {
        .species = SPECIES_LATIAS,
        .moves = {MOVE_CALM_MIND, MOVE_RECOVER, MOVE_PSYSHOCK, MOVE_DRAGON_PULSE},
        .heldItem = ITEM_LEFTOVERS,
    ...
    [FRONTIER_MON_MAGNEZONE_2] = {
        .species = SPECIES_MAGNEZONE,
        .moves = {MOVE_BODY_PRESS, MOVE_IRON_DEFENSE, MOVE_THUNDERBOLT, MOVE_VOLT_SWITCH},
        .heldItem = ITEM_AIR_BALLOON,
    ...
    [FRONTIER_MON_GLISCOR_1] = {
        ...
        .moves = {MOVE_TOXIC, MOVE_EARTHQUAKE, MOVE_PROTECT, MOVE_KNOCK_OFF},
        .heldItem = ITEM_TOXIC_ORB,
        .ev = TRAINER_PARTY_EVS(244, 0, 248, 0, 0, 16),
    ...
    [FRONTIER_MON_CLEFABLE_M1] = {
        .species = SPECIES_CLEFABLE,
        .moves = {MOVE_CALM_MIND, MOVE_MOONBLAST, MOVE_MOONLIGHT, MOVE_FLAMETHROWER},
        .heldItem = ITEM_LEFTOVERS,
        .ev = TRAINER_PARTY_EVS(252, 0, 172, 0, 84, 0),
    ...
    [FRONTIER_MON_FERROTHORN_1] = {
        ...
        .moves = {MOVE_SPIKES, MOVE_LEECH_SEED, MOVE_POWER_WHIP, MOVE_KNOCK_OFF},
        .heldItem = ITEM_LEFTOVERS,
    ...
    [FRONTIER_MON_ROTOM_WASH_2] = {
        .species = SPECIES_ROTOM_WASH,
        .moves = {MOVE_HYDRO_PUMP, MOVE_THUNDERBOLT, MOVE_VOLT_SWITCH, MOVE_TRICK},
        .heldItem = ITEM_CHOICE_SPECS,
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 4),
        .ability = ABILITY_LEVITATE,
        .nature = NATURE_TIMID,
    ...
    [FRONTIER_MON_LANDORUS_THERIAN_2] = {
        .species = SPECIES_LANDORUS_THERIAN,
        .moves = {MOVE_STEALTH_ROCK, MOVE_EARTHQUAKE, MOVE_U_TURN, MOVE_DEFOG},
    ...
    [FRONTIER_MON_THUNDURUS_THERIAN_1] = {
        ...
        .moves = {MOVE_THUNDERBOLT, MOVE_FOCUS_BLAST, MOVE_VOLT_SWITCH, MOVE_GRASS_KNOT},
        .heldItem = ITEM_CHOICE_SPECS,
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 4),
    ...
    [FRONTIER_MON_KYUREM_BLACK_1] = {
        ...
        .moves = {MOVE_DRAGON_DANCE, MOVE_ICICLE_CRASH, MOVE_OUTRAGE, MOVE_ROOST},
        .heldItem = ITEM_LEFTOVERS,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 4),
    ...
    [FRONTIER_MON_TAPU_KOKO_2] = {
        .species = SPECIES_TAPU_KOKO,
        .moves = {MOVE_WILD_CHARGE, MOVE_BRAVE_BIRD, MOVE_U_TURN, MOVE_VOLT_SWITCH},
        .heldItem = ITEM_LIFE_ORB,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 4),
        .ability = ABILITY_ELECTRIC_SURGE,
        .nature = NATURE_JOLLY,
    ...
    [FRONTIER_MON_TAPU_LELE_1] = {
        ...
        .moves = {MOVE_PSYSHOCK, MOVE_MOONBLAST, MOVE_FOCUS_BLAST, MOVE_THUNDERBOLT},
        .heldItem = ITEM_CHOICE_SPECS,
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 4),
    ...
    [FRONTIER_MON_TAPU_BULU_1] = {
        ...
        .moves = {MOVE_WOOD_HAMMER, MOVE_HORN_LEECH, MOVE_STONE_EDGE, MOVE_SUPERPOWER},
        .heldItem = ITEM_CHOICE_BAND,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 4),
    ...
    [FRONTIER_MON_TAPU_FINI_1] = {
        ...
        .moves = {MOVE_CALM_MIND, MOVE_MOONBLAST, MOVE_SURF, MOVE_DEFOG},
        .heldItem = ITEM_LEFTOVERS,
        .ev = TRAINER_PARTY_EVS(252, 0, 0, 252, 4, 0),
    ...
    [FRONTIER_MON_CINDERACE_1] = {
        ...
        .moves = {MOVE_PYRO_BALL, MOVE_HIGH_JUMP_KICK, MOVE_GUNK_SHOT, MOVE_U_TURN},
        .heldItem = ITEM_LIFE_ORB,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 4),
    ...
    [FRONTIER_MON_CORVIKNIGHT_1] = {
        ...
        .moves = {MOVE_BULK_UP, MOVE_BODY_PRESS, MOVE_BRAVE_BIRD, MOVE_ROOST},
        .heldItem = ITEM_LEFTOVERS,
        .ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 0, 4),
    ...
    [FRONTIER_MON_DRAGAPULT_2] = {
        .species = SPECIES_DRAGAPULT,
        .moves = {MOVE_DRAGON_DANCE, MOVE_DRAGON_DARTS, MOVE_PHANTOM_FORCE, MOVE_U_TURN},
        .heldItem = ITEM_LIFE_ORB,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 4),
        .ability = ABILITY_CLEAR_BODY,
        .nature = NATURE_JOLLY,
    ...
    [FRONTIER_MON_KINGAMBIT_1] = {
        ...
        .moves = {MOVE_SWORDS_DANCE, MOVE_KOWTOW_CLEAVE, MOVE_SUCKER_PUNCH, MOVE_IRON_HEAD},
        .heldItem = ITEM_LEFTOVERS,
    ...
    [FRONTIER_MON_IRON_VALIANT_1] = {
        ...
        .moves = {MOVE_MOONBLAST, MOVE_CLOSE_COMBAT, MOVE_KNOCK_OFF, MOVE_SHADOW_BALL},
        .heldItem = ITEM_BOOSTER_ENERGY,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 4),
    ...
    [FRONTIER_MON_ROARING_MOON_1] = {
        ...
        .moves = {MOVE_DRAGON_DANCE, MOVE_KNOCK_OFF, MOVE_EARTHQUAKE, MOVE_ACROBATICS},
        .heldItem = ITEM_LIFE_ORB,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 4),
        .ability = ABILITY_PROTOSYNTHESIS,
        .nature = NATURE_JOLLY,
    ...
    [FRONTIER_MON_FLUTTER_MANE_1] = {
        ...
        .moves = {MOVE_CALM_MIND, MOVE_MOONBLAST, MOVE_SHADOW_BALL, MOVE_MYSTICAL_FIRE},
        .heldItem = ITEM_LIFE_ORB,
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 4),
        .ability = ABILITY_PROTOSYNTHESIS,
        .nature = NATURE_TIMID,
    ...
    [FRONTIER_MON_CHIEN_PAO_1] = {
        ...
        .moves = {MOVE_ICICLE_CRASH, MOVE_CRUNCH, MOVE_ICE_SHARD, MOVE_SUCKER_PUNCH},
        .heldItem = ITEM_CHOICE_BAND,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 4),
    ...
    [FRONTIER_MON_TING_LU_1] = {
        ...
        .moves = {MOVE_STEALTH_ROCK, MOVE_SPIKES, MOVE_EARTHQUAKE, MOVE_RUINATION},
        .heldItem = ITEM_LEFTOVERS,
        .ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 252, 0),
    ...
    // -- v1.9: Modern early-route fodder for lower-tier Frontier trainers --
    [FRONTIER_MON_BIDOOF] = {
        .species = SPECIES_BIDOOF,
        .moves = {MOVE_TACKLE, MOVE_DEFENSE_CURL, MOVE_ROLLOUT, MOVE_HEADBUTT},
    ...
    [FRONTIER_MON_SHINX] = {
        ...
        .moves = {MOVE_TACKLE, MOVE_THUNDER_SHOCK, MOVE_LEER, MOVE_BITE},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0),
        .nature = NATURE_ADAMANT,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_BUDEW] = {
        ...
        .moves = {MOVE_ABSORB, MOVE_GROWTH, MOVE_WATER_SPORT, MOVE_STUN_SPORE},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 0, 0, 0, 252, 0),
        .nature = NATURE_MODEST,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_BUIZEL] = {
        ...
        .moves = {MOVE_WATER_GUN, MOVE_QUICK_ATTACK, MOVE_SWIFT, MOVE_PURSUIT},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 0),
        .nature = NATURE_HASTY,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_PATRAT] = {
        ...
        .moves = {MOVE_TACKLE, MOVE_LEER, MOVE_BITE, MOVE_BIDE},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0),
        .nature = NATURE_ADAMANT,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_LILLIPUP] = {
        ...
        .moves = {MOVE_TACKLE, MOVE_LEER, MOVE_BITE, MOVE_BABY_DOLL_EYES},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0),
        .nature = NATURE_JOLLY,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_ROGGENROLA] = {
        ...
        .moves = {MOVE_TACKLE, MOVE_HARDEN, MOVE_ROCK_BLAST, MOVE_MUD_SLAP},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 252, 0, 0, 0, 0),
        .nature = NATURE_ADAMANT,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_WOOBAT] = {
        ...
        .moves = {MOVE_CONFUSION, MOVE_GUST, MOVE_ASSURANCE, MOVE_HEART_STAMP},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 0),
        .nature = NATURE_TIMID,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_COTTONEE] = {
        ...
        .moves = {MOVE_ABSORB, MOVE_GROWTH, MOVE_LEECH_SEED, MOVE_STUN_SPORE},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 0, 0, 252, 0, 0),
        .nature = NATURE_MODEST,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_FLETCHLING] = {
        ...
        .moves = {MOVE_TACKLE, MOVE_GROWL, MOVE_QUICK_ATTACK, MOVE_PECK},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0),
        .nature = NATURE_JOLLY,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_LITLEO] = {
        ...
        .moves = {MOVE_TACKLE, MOVE_LEER, MOVE_EMBER, MOVE_WORK_UP},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 0),
        .nature = NATURE_MODEST,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_PANCHAM] = {
        ...
        .moves = {MOVE_TACKLE, MOVE_LEER, MOVE_ARM_THRUST, MOVE_WORK_UP},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0),
        .nature = NATURE_ADAMANT,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_YUNGOOS] = {
        ...
        .moves = {MOVE_TACKLE, MOVE_LEER, MOVE_BITE, MOVE_PURSUIT},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0),
        .nature = NATURE_ADAMANT,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_PIKIPEK] = {
        ...
        .moves = {MOVE_PECK, MOVE_GROWL, MOVE_ECHOED_VOICE, MOVE_PLUCK},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0),
        .nature = NATURE_JOLLY,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_GRUBBIN] = {
        ...
        .moves = {MOVE_VICE_GRIP, MOVE_STRING_SHOT, MOVE_MUD_SLAP, MOVE_BITE},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 252, 0, 0, 0, 0),
        .nature = NATURE_ADAMANT,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_BOUNSWEET] = {
        ...
        .moves = {MOVE_SPLASH, MOVE_RAPID_SPIN, MOVE_PLAY_NICE, MOVE_RAZOR_LEAF},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 0, 0, 252, 0, 0),
        .nature = NATURE_TIMID,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_SKWOVET] = {
        ...
        .moves = {MOVE_TACKLE, MOVE_TAIL_WHIP, MOVE_BITE, MOVE_STUFF_CHEEKS},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 252, 0, 0, 0, 0),
        .nature = NATURE_HARDY,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_ROOKIDEE] = {
        ...
        .moves = {MOVE_PECK, MOVE_LEER, MOVE_POWER_TRIP, MOVE_FURY_ATTACK},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0),
        .nature = NATURE_JOLLY,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_BLIPBUG] = {
        ...
        .moves = {MOVE_STRUGGLE_BUG, MOVE_INFESTATION, MOVE_NONE, MOVE_NONE},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 0, 0, 0, 252, 0),
        .nature = NATURE_MODEST,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_WOOLOO] = {
        ...
        .moves = {MOVE_TACKLE, MOVE_GROWL, MOVE_DEFENSE_CURL, MOVE_COPYCAT},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 252, 0, 0, 0, 0),
        .nature = NATURE_HARDY,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_YAMPER] = {
        ...
        .moves = {MOVE_TACKLE, MOVE_TAIL_WHIP, MOVE_NUZZLE, MOVE_BITE},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0),
        .nature = NATURE_JOLLY,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_LECHONK] = {
        ...
        .moves = {MOVE_TACKLE, MOVE_TAIL_WHIP, MOVE_DISARMING_VOICE, MOVE_HEADBUTT},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 252, 0, 0, 0, 0),
        .nature = NATURE_HARDY,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_PAWMI] = {
        ...
        .moves = {MOVE_THUNDER_SHOCK, MOVE_TAIL_WHIP, MOVE_QUICK_ATTACK, MOVE_NUZZLE},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0),
        .nature = NATURE_JOLLY,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_FIDOUGH] = {
        ...
        .moves = {MOVE_TACKLE, MOVE_FAIRY_WIND, MOVE_BABY_DOLL_EYES, MOVE_PLAY_ROUGH},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0),
        .nature = NATURE_JOLLY,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_SMOLIV] = {
        ...
        .moves = {MOVE_TACKLE, MOVE_LEAFAGE, MOVE_RAZOR_LEAF, MOVE_GROWTH},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 0, 0, 0, 252, 0),
        .nature = NATURE_MODEST,
        .ball = BALL_POKE
    ...
    [FRONTIER_MON_TANDEMAUS] = {
        ...
        .moves = {MOVE_SCRATCH, MOVE_TAIL_WHIP, MOVE_BITE, MOVE_HELPING_HAND},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0),
        .nature = NATURE_JOLLY,
        .ball = BALL_POKE
    ...
    // -- v1.9: Unova monkeys (early-route trio) --
    [FRONTIER_MON_PANSAGE] = { .species = SPECIES_PANSAGE, .moves = {MOVE_SCRATCH, MOVE_VINE_WHIP, MOVE_LEER, MOVE_BITE}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_HARDY, .ball = BALL_POKE },
    [FRONTIER_MON_SIMISAGE] = { .species = SPECIES_SIMISAGE, .moves = {MOVE_SEED_BOMB, MOVE_ROCK_TOMB, MOVE_CRUNCH, MOVE_GRASS_KNOT}, .heldItem = ITEM_SITRUS_BERRY, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_HASTY, .ball = BALL_POKE },
    [FRONTIER_MON_PANSEAR] = { .species = SPECIES_PANSEAR, .moves = {MOVE_SCRATCH, MOVE_EMBER, MOVE_LEER, MOVE_BITE}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_HARDY, .ball = BALL_POKE },
    [FRONTIER_MON_SIMISEAR] = { .species = SPECIES_SIMISEAR, .moves = {MOVE_FIRE_BLAST, MOVE_FOCUS_BLAST, MOVE_CRUNCH, MOVE_ROCK_TOMB}, .heldItem = ITEM_SITRUS_BERRY, .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 0), .nature = NATURE_MODEST, .ball = BALL_POKE },
    [FRONTIER_MON_PANPOUR] = { .species = SPECIES_PANPOUR, .moves = {MOVE_SCRATCH, MOVE_WATER_GUN, MOVE_LEER, MOVE_BITE}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_HARDY, .ball = BALL_POKE },
    [FRONTIER_MON_SIMIPOUR] = { .species = SPECIES_SIMIPOUR, .moves = {MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_GRASS_KNOT, MOVE_FOCUS_BLAST}, .heldItem = ITEM_SITRUS_BERRY, .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 0), .nature = NATURE_MODEST, .ball = BALL_POKE },
    // -- v1.9: Pseudo-legendary first and second stage lines --
    [FRONTIER_MON_GIBLE] = { .species = SPECIES_GIBLE, .moves = {MOVE_TACKLE, MOVE_SAND_ATTACK, MOVE_DRAGON_RAGE, MOVE_TAKE_DOWN}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_ADAMANT, .ball = BALL_POKE },
    [FRONTIER_MON_GABITE] = { .species = SPECIES_GABITE, .moves = {MOVE_DRAGON_CLAW, MOVE_DIG, MOVE_DUAL_CHOP, MOVE_TAKE_DOWN}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_JOLLY, .ball = BALL_POKE },
    [FRONTIER_MON_BAGON_2] = { .species = SPECIES_BAGON, .moves = {MOVE_BITE, MOVE_LEER, MOVE_EMBER, MOVE_DRAGON_BREATH}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_ADAMANT, .ball = BALL_POKE },
    [FRONTIER_MON_SHELGON] = { .species = SPECIES_SHELGON, .moves = {MOVE_DRAGON_BREATH, MOVE_EMBER, MOVE_HEADBUTT, MOVE_PROTECT}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(252, 252, 0, 0, 0, 0), .nature = NATURE_ADAMANT, .ball = BALL_POKE },
    [FRONTIER_MON_LARVITAR_2] = { .species = SPECIES_LARVITAR, .moves = {MOVE_BITE, MOVE_LEER, MOVE_SAND_ATTACK, MOVE_ROCK_THROW}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_ADAMANT, .ball = BALL_POKE },
    [FRONTIER_MON_PUPITAR] = { .species = SPECIES_PUPITAR, .moves = {MOVE_STONE_EDGE, MOVE_CRUNCH, MOVE_SAND_TOMB, MOVE_EARTHQUAKE}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_ADAMANT, .ball = BALL_POKE },
    [FRONTIER_MON_DEINO] = { .species = SPECIES_DEINO, .moves = {MOVE_TACKLE, MOVE_DRAGON_RAGE, MOVE_FOCUS_ENERGY, MOVE_BITE}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 0), .nature = NATURE_MODEST, .ball = BALL_POKE },
    [FRONTIER_MON_ZWEILOUS] = { .species = SPECIES_ZWEILOUS, .moves = {MOVE_DRAGON_BREATH, MOVE_DARK_PULSE, MOVE_BITE, MOVE_CRUNCH}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 0), .nature = NATURE_MODEST, .ball = BALL_POKE },
    [FRONTIER_MON_GOOMY] = { .species = SPECIES_GOOMY, .moves = {MOVE_TACKLE, MOVE_BUBBLE, MOVE_ABSORB, MOVE_PROTECT}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(252, 0, 0, 0, 252, 0), .nature = NATURE_MODEST, .ball = BALL_POKE },
    [FRONTIER_MON_SLIGGOO] = { .species = SPECIES_SLIGGOO, .moves = {MOVE_WATER_PULSE, MOVE_DRAGON_BREATH, MOVE_ICE_BEAM, MOVE_ABSORB}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(252, 0, 0, 0, 252, 0), .nature = NATURE_MODEST, .ball = BALL_POKE },
    [FRONTIER_MON_JANGMO_O] = { .species = SPECIES_JANGMO_O, .moves = {MOVE_TACKLE, MOVE_LEER, MOVE_PROTECT, MOVE_DRAGON_TAIL}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_JOLLY, .ball = BALL_POKE },
    [FRONTIER_MON_HAKAMO_O] = { .species = SPECIES_HAKAMO_O, .moves = {MOVE_DRAGON_CLAW, MOVE_BRICK_BREAK, MOVE_AUTOTOMIZE, MOVE_HEADBUTT}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_JOLLY, .ball = BALL_POKE },
    [FRONTIER_MON_DREEPY] = { .species = SPECIES_DREEPY, .moves = {MOVE_ASTONISH, MOVE_INFESTATION, MOVE_BITE, MOVE_QUICK_ATTACK}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 0), .nature = NATURE_TIMID, .ball = BALL_POKE },
    [FRONTIER_MON_DRAKLOAK] = { .species = SPECIES_DRAKLOAK, .moves = {MOVE_PHANTOM_FORCE, MOVE_DRAGON_BREATH, MOVE_U_TURN, MOVE_QUICK_ATTACK}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_JOLLY, .ball = BALL_POKE },
    [FRONTIER_MON_FRIGIBAX] = { .species = SPECIES_FRIGIBAX, .moves = {MOVE_BITE, MOVE_ICY_WIND, MOVE_DRAGON_BREATH, MOVE_PROTECT}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_JOLLY, .ball = BALL_POKE },
    [FRONTIER_MON_ARCTIBAX] = { .species = SPECIES_ARCTIBAX, .moves = {MOVE_ICE_FANG, MOVE_DRAGON_CLAW, MOVE_ICY_WIND, MOVE_PROTECT}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_JOLLY, .ball = BALL_POKE },
    // -- v1.9: Modern starter first stages (Gen 4-9) --
    [FRONTIER_MON_TURTWIG] = { .species = SPECIES_TURTWIG, .moves = {MOVE_TACKLE, MOVE_ABSORB, MOVE_WITHDRAW, MOVE_RAZOR_LEAF}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(252, 252, 0, 0, 0, 0), .nature = NATURE_BOLD, .ball = BALL_POKE },
    [FRONTIER_MON_CHIMCHAR] = { .species = SPECIES_CHIMCHAR, .moves = {MOVE_SCRATCH, MOVE_LEER, MOVE_EMBER, MOVE_TAUNT}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 0), .nature = NATURE_HASTY, .ball = BALL_POKE },
    [FRONTIER_MON_PIPLUP] = { .species = SPECIES_PIPLUP, .moves = {MOVE_POUND, MOVE_GROWL, MOVE_BUBBLE, MOVE_PECK}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 0), .nature = NATURE_MODEST, .ball = BALL_POKE },
    [FRONTIER_MON_GROTLE] = { .species = SPECIES_GROTLE, .moves = {MOVE_RAZOR_LEAF, MOVE_BITE, MOVE_MEGA_DRAIN, MOVE_CURSE}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(252, 252, 0, 0, 0, 0), .nature = NATURE_BOLD, .ball = BALL_POKE },
    [FRONTIER_MON_MONFERNO] = { .species = SPECIES_MONFERNO, .moves = {MOVE_FLAME_WHEEL, MOVE_MACH_PUNCH, MOVE_FURY_SWIPES, MOVE_TAUNT}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_ADAMANT, .ball = BALL_POKE },
    [FRONTIER_MON_PRINPLUP] = { .species = SPECIES_PRINPLUP, .moves = {MOVE_BUBBLE_BEAM, MOVE_PECK, MOVE_METAL_CLAW, MOVE_PROTECT}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 0), .nature = NATURE_MODEST, .ball = BALL_POKE },
    [FRONTIER_MON_SNIVY] = { .species = SPECIES_SNIVY, .moves = {MOVE_TACKLE, MOVE_LEER, MOVE_VINE_WHIP, MOVE_WRAP}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 0), .nature = NATURE_TIMID, .ball = BALL_POKE },
    [FRONTIER_MON_TEPIG] = { .species = SPECIES_TEPIG, .moves = {MOVE_TACKLE, MOVE_TAIL_WHIP, MOVE_EMBER, MOVE_ODOR_SLEUTH}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(252, 252, 0, 0, 0, 0), .nature = NATURE_ADAMANT, .ball = BALL_POKE },
    [FRONTIER_MON_OSHAWOTT] = { .species = SPECIES_OSHAWOTT, .moves = {MOVE_TACKLE, MOVE_TAIL_WHIP, MOVE_WATER_GUN, MOVE_FOCUS_ENERGY}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 0), .nature = NATURE_MODEST, .ball = BALL_POKE },
    [FRONTIER_MON_SERVINE] = { .species = SPECIES_SERVINE, .moves = {MOVE_VINE_WHIP, MOVE_LEAF_TORNADO, MOVE_GIGA_DRAIN, MOVE_MEGA_DRAIN}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 0), .nature = NATURE_TIMID, .ball = BALL_POKE },
    [FRONTIER_MON_PIGNITE] = { .species = SPECIES_PIGNITE, .moves = {MOVE_FLAME_CHARGE, MOVE_ARM_THRUST, MOVE_HEAT_CRASH, MOVE_ROLLOUT}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(252, 252, 0, 0, 0, 0), .nature = NATURE_ADAMANT, .ball = BALL_POKE },
    [FRONTIER_MON_DEWOTT] = { .species = SPECIES_DEWOTT, .moves = {MOVE_WATER_PULSE, MOVE_FURY_CUTTER, MOVE_FOCUS_ENERGY, MOVE_RAZOR_SHELL}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_ADAMANT, .ball = BALL_POKE },
    [FRONTIER_MON_CHESPIN] = { .species = SPECIES_CHESPIN, .moves = {MOVE_TACKLE, MOVE_GROWL, MOVE_VINE_WHIP, MOVE_ROLLOUT}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(252, 252, 0, 0, 0, 0), .nature = NATURE_ADAMANT, .ball = BALL_POKE },
    [FRONTIER_MON_FENNEKIN] = { .species = SPECIES_FENNEKIN, .moves = {MOVE_SCRATCH, MOVE_TAIL_WHIP, MOVE_EMBER, MOVE_HOWL}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 0), .nature = NATURE_MODEST, .ball = BALL_POKE },
    [FRONTIER_MON_FROAKIE] = { .species = SPECIES_FROAKIE, .moves = {MOVE_POUND, MOVE_GROWL, MOVE_BUBBLE, MOVE_QUICK_ATTACK}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 0), .nature = NATURE_TIMID, .ball = BALL_POKE },
    [FRONTIER_MON_QUILLADIN] = { .species = SPECIES_QUILLADIN, .moves = {MOVE_NEEDLE_ARM, MOVE_ROLLOUT, MOVE_BITE, MOVE_MUD_SHOT}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(252, 252, 0, 0, 0, 0), .nature = NATURE_ADAMANT, .ball = BALL_POKE },
    [FRONTIER_MON_BRAIXEN] = { .species = SPECIES_BRAIXEN, .moves = {MOVE_FIRE_SPIN, MOVE_PSYBEAM, MOVE_FLAME_CHARGE, MOVE_LIGHT_SCREEN}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 0), .nature = NATURE_MODEST, .ball = BALL_POKE },
    [FRONTIER_MON_FROGADIER] = { .species = SPECIES_FROGADIER, .moves = {MOVE_WATER_PULSE, MOVE_BOUNCE, MOVE_SMACK_DOWN, MOVE_QUICK_ATTACK}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 0), .nature = NATURE_TIMID, .ball = BALL_POKE },
    [FRONTIER_MON_ROWLET] = { .species = SPECIES_ROWLET, .moves = {MOVE_TACKLE, MOVE_LEAFAGE, MOVE_GROWL, MOVE_ASTONISH}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_ADAMANT, .ball = BALL_POKE },
    [FRONTIER_MON_LITTEN] = { .species = SPECIES_LITTEN, .moves = {MOVE_SCRATCH, MOVE_EMBER, MOVE_GROWL, MOVE_LICK}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_ADAMANT, .ball = BALL_POKE },
    [FRONTIER_MON_POPPLIO] = { .species = SPECIES_POPPLIO, .moves = {MOVE_POUND, MOVE_WATER_GUN, MOVE_GROWL, MOVE_DISARMING_VOICE}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 0), .nature = NATURE_MODEST, .ball = BALL_POKE },
    [FRONTIER_MON_DARTRIX] = { .species = SPECIES_DARTRIX, .moves = {MOVE_RAZOR_LEAF, MOVE_PECK, MOVE_ASTONISH, MOVE_U_TURN}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_ADAMANT, .ball = BALL_POKE },
    [FRONTIER_MON_TORRACAT] = { .species = SPECIES_TORRACAT, .moves = {MOVE_FIRE_FANG, MOVE_BITE, MOVE_FURY_SWIPES, MOVE_FLAME_CHARGE}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_ADAMANT, .ball = BALL_POKE },
    [FRONTIER_MON_BRIONNE] = { .species = SPECIES_BRIONNE, .moves = {MOVE_BUBBLE_BEAM, MOVE_DISARMING_VOICE, MOVE_ENCORE, MOVE_AQUA_JET}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 0), .nature = NATURE_MODEST, .ball = BALL_POKE },
    [FRONTIER_MON_GROOKEY] = { .species = SPECIES_GROOKEY, .moves = {MOVE_SCRATCH, MOVE_GROWL, MOVE_BRANCH_POKE, MOVE_TAUNT}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_ADAMANT, .ball = BALL_POKE },
    [FRONTIER_MON_SCORBUNNY] = { .species = SPECIES_SCORBUNNY, .moves = {MOVE_TACKLE, MOVE_GROWL, MOVE_EMBER, MOVE_QUICK_ATTACK}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_JOLLY, .ball = BALL_POKE },
    [FRONTIER_MON_SOBBLE] = { .species = SPECIES_SOBBLE, .moves = {MOVE_POUND, MOVE_GROWL, MOVE_WATER_GUN, MOVE_BIND}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 0), .nature = NATURE_TIMID, .ball = BALL_POKE },
    [FRONTIER_MON_THWACKEY] = { .species = SPECIES_THWACKEY, .moves = {MOVE_DOUBLE_HIT, MOVE_BRANCH_POKE, MOVE_KNOCK_OFF, MOVE_SCREECH}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_ADAMANT, .ball = BALL_POKE },
    [FRONTIER_MON_RABOOT] = { .species = SPECIES_RABOOT, .moves = {MOVE_EMBER, MOVE_QUICK_ATTACK, MOVE_DOUBLE_KICK, MOVE_FLAME_CHARGE}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_JOLLY, .ball = BALL_POKE },
    [FRONTIER_MON_DRIZZILE] = { .species = SPECIES_DRIZZILE, .moves = {MOVE_WATER_PULSE, MOVE_U_TURN, MOVE_BIND, MOVE_QUICK_ATTACK}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 0), .nature = NATURE_TIMID, .ball = BALL_POKE },
    [FRONTIER_MON_SPRIGATITO] = { .species = SPECIES_SPRIGATITO, .moves = {MOVE_SCRATCH, MOVE_LEAFAGE, MOVE_TAIL_WHIP, MOVE_BITE}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_JOLLY, .ball = BALL_POKE },
    [FRONTIER_MON_FLORAGATO] = { .species = SPECIES_FLORAGATO, .moves = {MOVE_MAGICAL_LEAF, MOVE_BITE, MOVE_U_TURN, MOVE_PETAL_DANCE}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_JOLLY, .ball = BALL_POKE },
    [FRONTIER_MON_FUECOCO] = { .species = SPECIES_FUECOCO, .moves = {MOVE_TACKLE, MOVE_LEER, MOVE_EMBER, MOVE_BITE}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(252, 0, 0, 0, 252, 0), .nature = NATURE_MODEST, .ball = BALL_POKE },
    [FRONTIER_MON_CROCALOR] = { .species = SPECIES_CROCALOR, .moves = {MOVE_BITE, MOVE_EMBER, MOVE_ROUND, MOVE_INCINERATE}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(252, 0, 0, 0, 252, 0), .nature = NATURE_MODEST, .ball = BALL_POKE },
    [FRONTIER_MON_QUAXLY] = { .species = SPECIES_QUAXLY, .moves = {MOVE_POUND, MOVE_WATER_GUN, MOVE_GROWL, MOVE_FURY_ATTACK}, .heldItem = ITEM_ORAN_BERRY, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_ADAMANT, .ball = BALL_POKE },
    [FRONTIER_MON_QUAXWELL] = { .species = SPECIES_QUAXWELL, .moves = {MOVE_WATER_PULSE, MOVE_AQUA_JET, MOVE_AERIAL_ACE, MOVE_FURY_ATTACK}, .heldItem = ITEM_EVIOLITE, .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0), .nature = NATURE_ADAMANT, .ball = BALL_POKE },
    // -- v1.9: Non-restricted legendaries for high-tier pools --
    [FRONTIER_MON_MESPRIT] = {
        .species = SPECIES_MESPRIT,
        .moves = {MOVE_CALM_MIND, MOVE_PSYCHIC, MOVE_ICE_BEAM, MOVE_HEALING_WISH},
        .heldItem = ITEM_LEFTOVERS,
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 4),
        .nature = NATURE_TIMID,
        .ball = BALL_PREMIER
    ...
    [FRONTIER_MON_AZELF] = {
        ...
        .moves = {MOVE_NASTY_PLOT, MOVE_PSYCHIC, MOVE_DAZZLING_GLEAM, MOVE_EXPLOSION},
        .heldItem = ITEM_LIFE_ORB,
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 4),
        .nature = NATURE_TIMID,
        .ball = BALL_PREMIER
    ...
    [FRONTIER_MON_UXIE] = {
        ...
        .moves = {MOVE_STEALTH_ROCK, MOVE_PSYCHIC, MOVE_U_TURN, MOVE_MEMENTO},
        .heldItem = ITEM_FOCUS_SASH,
    ...
    [FRONTIER_MON_REGIDRAGO] = {
        ...
        .moves = {MOVE_DRAGON_CLAW, MOVE_OUTRAGE, MOVE_EARTHQUAKE, MOVE_GLAIVE_RUSH},
        .heldItem = ITEM_CHOICE_BAND,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 4),
    ...
    [FRONTIER_MON_COBALION] = {
        ...
        .moves = {MOVE_SWORDS_DANCE, MOVE_IRON_HEAD, MOVE_CLOSE_COMBAT, MOVE_STONE_EDGE},
        .heldItem = ITEM_LIFE_ORB,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 4),
    ...
    [FRONTIER_MON_KELDEO] = {
        ...
        .moves = {MOVE_SECRET_SWORD, MOVE_HYDRO_PUMP, MOVE_SURF, MOVE_ICY_WIND},
        .heldItem = ITEM_CHOICE_SCARF,
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 4),
        .ability = ABILITY_JUSTIFIED,
        .nature = NATURE_TIMID,
    ...
    [FRONTIER_MON_PHEROMOSA] = {
        ...
        .moves = {MOVE_HIGH_JUMP_KICK, MOVE_TRIPLE_AXEL, MOVE_U_TURN, MOVE_QUIVER_DANCE},
        .heldItem = ITEM_LIFE_ORB,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 4),
    ...
    [FRONTIER_MON_KARTANA] = {
        ...
        .moves = {MOVE_SWORDS_DANCE, MOVE_SMART_STRIKE, MOVE_LEAF_BLADE, MOVE_SACRED_SWORD},
        .heldItem = ITEM_LIFE_ORB,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 4),
        .ability = ABILITY_BEAST_BOOST,
        .nature = NATURE_JOLLY,
    ...
    [FRONTIER_MON_BUZZWOLE] = {
        ...
        .moves = {MOVE_BULK_UP, MOVE_DRAIN_PUNCH, MOVE_ICE_PUNCH, MOVE_ROOST},
        .heldItem = ITEM_LEFTOVERS,
    ...
    [FRONTIER_MON_GENESECT] = {
        ...
        .moves = {MOVE_U_TURN, MOVE_IRON_HEAD, MOVE_ICE_BEAM, MOVE_TECHNO_BLAST},
        .heldItem = ITEM_CHOICE_SCARF,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 4),
    ...
    [FRONTIER_MON_MELOETTA] = {
        ...
        .moves = {MOVE_CALM_MIND, MOVE_PSYSHOCK, MOVE_FOCUS_BLAST, MOVE_SHADOW_BALL},
        .heldItem = ITEM_LEFTOVERS,
        .ev = TRAINER_PARTY_EVS(252, 0, 0, 252, 0, 4),
        .nature = NATURE_TIMID,
        .ball = BALL_PREMIER
    ...
    [FRONTIER_MON_CRESSELIA] = {
        ...
        .moves = {MOVE_MOONLIGHT, MOVE_PSYCHIC, MOVE_ICE_BEAM, MOVE_TOXIC},
        .heldItem = ITEM_LEFTOVERS,
        .ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 4, 0),
        .nature = NATURE_BOLD,
        .ball = BALL_PREMIER
    ...
    [FRONTIER_MON_MAGEARNA] = {
        ...
        .moves = {MOVE_CALM_MIND, MOVE_FLEUR_CANNON, MOVE_THUNDERBOLT, MOVE_PAIN_SPLIT},
        .heldItem = ITEM_LEFTOVERS,
        .ev = TRAINER_PARTY_EVS(252, 0, 0, 252, 4, 0),
    ...
    [FRONTIER_MON_SILVALLY] = {
        ...
        .moves = {MOVE_MULTI_ATTACK, MOVE_CRUNCH, MOVE_U_TURN, MOVE_IRON_HEAD},
        .heldItem = ITEM_LIFE_ORB,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 4),
        .nature = NATURE_ADAMANT,
        .ball = BALL_PREMIER
    ...
    [FRONTIER_MON_WO_CHIEN] = {
        ...
        .moves = {MOVE_LEECH_SEED, MOVE_RUINATION, MOVE_KNOCK_OFF, MOVE_PROTECT},
        .heldItem = ITEM_LEFTOVERS,
        .ev = TRAINER_PARTY_EVS(252, 0, 4, 0, 252, 0),
    ...
    [FRONTIER_MON_CHI_YU] = {
        ...
        .moves = {MOVE_OVERHEAT, MOVE_DARK_PULSE, MOVE_LAVA_PLUME, MOVE_PSYCHIC},
        .heldItem = ITEM_CHOICE_SCARF,
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 4),
    ...
    [FRONTIER_MON_JIRACHI_M1] = {
        ...
        .moves = {MOVE_IRON_HEAD, MOVE_BODY_SLAM, MOVE_STEALTH_ROCK, MOVE_U_TURN},
        .heldItem = ITEM_LEFTOVERS,
        .ev = TRAINER_PARTY_EVS(252, 252, 0, 0, 4, 0),
    ...
    [FRONTIER_MON_CELEBI_M1] = {
        ...
        .moves = {MOVE_NASTY_PLOT, MOVE_GIGA_DRAIN, MOVE_PSYCHIC, MOVE_RECOVER},
        .heldItem = ITEM_LIFE_ORB,
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 4),
    ...
    [FRONTIER_MON_VOLCANION] = {
        ...
        .moves = {MOVE_STEAM_ERUPTION, MOVE_FIRE_BLAST, MOVE_SLUDGE_BOMB, MOVE_EARTH_POWER},
        .heldItem = ITEM_CHOICE_SPECS,
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 4),
        .nature = NATURE_MODEST,
        .ball = BALL_PREMIER
