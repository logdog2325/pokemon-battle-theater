...
static const struct FrontierBrainMon sFrontierBrainsMons[][2][FRONTIER_PARTY_SIZE] =
{
        ...
        {
            {
                ...
                .heldItem = ITEM_LATIOSITE, // Mega Latios — Soul Heart-tier sweeper
                .fixedIV = MAX_PER_STAT_IVS,
                .nature = NATURE_TIMID,
                .evs = {0, 0, 0, 252, 4, 252},
                .moves = {MOVE_DRACO_METEOR, MOVE_PSYSHOCK, MOVE_AURA_SPHERE, MOVE_CALM_MIND},
            },
            {
                ...
                .nature = NATURE_TIMID,
                .evs = {0, 0, 0, 252, 4, 252},
                .moves = {MOVE_THUNDERBOLT, MOVE_VOLT_SWITCH, MOVE_AURA_SPHERE, MOVE_HIDDEN_POWER},
            },
            {
                .species = SPECIES_SNORLAX,
                ...
                .nature = NATURE_ADAMANT,
                .evs = {252, 252, 4, 0, 0, 0},
                .moves = {MOVE_BODY_SLAM, MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_PURSUIT},
            },
        },
    },
    [FRONTIER_FACILITY_DOME] =
        ...
        {
            {
                ...
                .heldItem = ITEM_METAGROSSITE, // Mega Metagross with Tough Claws
                .fixedIV = MAX_PER_STAT_IVS,
                .nature = NATURE_JOLLY,
                .evs = {0, 252, 0, 0, 4, 252},
                .moves = {MOVE_METEOR_MASH, MOVE_BULLET_PUNCH, MOVE_EARTHQUAKE, MOVE_ICE_PUNCH},
            },
            {
                .species = SPECIES_SWAMPERT,
                .heldItem = ITEM_LEFTOVERS,
    ...
    [FRONTIER_FACILITY_PALACE] =
    {
        ...
        // Gold Symbol. v1.11: buffed with modern movesets.
        {
            ...
            },
            {
                ...
                .nature = NATURE_ADAMANT,
                .evs = {0, 252, 4, 0, 0, 252},
                .moves = {MOVE_RETURN, MOVE_EARTHQUAKE, MOVE_SHADOW_CLAW, MOVE_NIGHT_SLASH},
            },
            {
                ...
                .nature = NATURE_BOLD,
                .evs = {252, 0, 252, 4, 0, 0},
                .moves = {MOVE_CALM_MIND, MOVE_SCALD, MOVE_ICE_BEAM, MOVE_RECOVER},
            },
        },
    },
    [FRONTIER_FACILITY_ARENA] =
        ...
        {
            {
                ...
                .heldItem = ITEM_GENGARITE, // Mega Gengar with Shadow Tag
                .fixedIV = MAX_PER_STAT_IVS,
                .nature = NATURE_TIMID,
                .evs = {0, 0, 0, 252, 4, 252},
            ...
            },
            {
                ...
                .nature = NATURE_JOLLY,
                .evs = {0, 252, 0, 0, 4, 252},
                .moves = {MOVE_SPORE, MOVE_MACH_PUNCH, MOVE_BULLET_SEED, MOVE_FORCE_PALM},
            },
        },
    },
    [FRONTIER_FACILITY_FACTORY] =
    {
        ...
        // v1.11: Silver — Steven's multi-battle classic squad, buffed.
        {
            {
                .species = SPECIES_METAGROSS,
                .heldItem = ITEM_LIFE_ORB,
            ...
            },
            {
                ...
                .evs = {252, 0, 252, 0, 4, 0},
                .moves = {MOVE_SPIKES, MOVE_ROOST, MOVE_BRAVE_BIRD, MOVE_WHIRLWIND},
            },
            {
                .species = SPECIES_AGGRON,
                .heldItem = ITEM_AGGRONITE, // Mega Aggron — Filter
                .fixedIV = MAX_PER_STAT_IVS,
                .nature = NATURE_ADAMANT,
                .evs = {252, 252, 4, 0, 0, 0},
                .moves = {MOVE_HEAVY_SLAM, MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_STEALTH_ROCK},
            },
        },
        // v1.11: Gold — same team but Mega Metagross + bulkier teammates.
        {
            {
                .species = SPECIES_METAGROSS,
            ...
            },
            {
                ...
                .nature = NATURE_IMPISH,
                .evs = {252, 0, 252, 0, 4, 0},
                .moves = {MOVE_STEALTH_ROCK, MOVE_SPIKES, MOVE_ROOST, MOVE_BRAVE_BIRD},
            },
            {
                .species = SPECIES_AGGRON,
                .heldItem = ITEM_AGGRONITE, // Mega Aggron
                .fixedIV = MAX_PER_STAT_IVS,
                .nature = NATURE_ADAMANT,
                .evs = {252, 252, 4, 0, 0, 0},
                .moves = {MOVE_HEAVY_SLAM, MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_BODY_PRESS},
            },
        },
    },
    [FRONTIER_FACILITY_PIKE] =
        ...
        {
            {
                ...
                .heldItem = ITEM_GYARADOSITE, // Mega Gyarados with Mold Breaker
                .fixedIV = MAX_PER_STAT_IVS,
                .nature = NATURE_JOLLY,
                .evs = {0, 252, 4, 0, 0, 252},
            ...
            },
            {
                ...
                .heldItem = ITEM_STEELIXITE, // Mega Steelix with Sand Force
                .fixedIV = MAX_PER_STAT_IVS,
                .nature = NATURE_ADAMANT,
                .evs = {252, 252, 4, 0, 0, 0},
                .moves = {MOVE_HEAVY_SLAM, MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_STEALTH_ROCK},
            },
            {
                ...
                .nature = NATURE_MODEST,
                .evs = {0, 0, 0, 252, 4, 252},
                .moves = {MOVE_SLUDGE_WAVE, MOVE_EARTHQUAKE, MOVE_FLAMETHROWER, MOVE_GIGA_DRAIN},
            },
        },
    },
    [FRONTIER_FACILITY_PYRAMID] =
...
static void AppendIfValid(u16 species, u16 heldItem, u16 hp, enum FrontierLevelMode lvlMode, u8 monLevel, u16 *speciesArray, u16 *itemsArray, u8 *count)
{
    ...
    if (species == SPECIES_EGG || species == SPECIES_NONE)
        return;
    // v2.0.4.6 — legality filter disabled. See party_menu.c IsMonAllowedInBattleTower.
...
static void CheckPartyIneligibility(void)
{
    ...
    if (numEligibleMons < toChoose)
    {
        ...
        // v2.0.4.6 — both loops below are vestigial after the legality filter
        // was disabled (party_menu.c IsMonAllowedInBattleTower). They build a
        // user-facing "you can't bring these mons" message that we'll never
        // show because we no longer treat any species as Frontier-banned.
        // Forcing the counters to 0 short-circuits the message-build path.
        // Kept the loop bodies so a future re-enable just flips the gate.
        for (i = 0; i < NUM_SPECIES; i++)
        {
            if (!IsSpeciesEnabled(i))
                continue;
            baseSpecies = GET_BASE_SPECIES_ID(i);
            if (FALSE && baseSpecies == i && gSpeciesInfo[baseSpecies].isFrontierBanned)
            {
        ...
        for (i = 0; i < PARTY_SIZE; i++)
        {
            ...
            if (species == SPECIES_EGG || species == SPECIES_NONE)
                continue;
            if (FALSE && gSpeciesInfo[GET_BASE_SPECIES_ID(species)].isFrontierBanned)
            {
...
static u16 *MakeCaughtBannesSpeciesList(u32 totalBannedSpecies)
{
    ...
    // v2.0.4.6 — see party_menu.c IsMonAllowedInBattleTower for the disable.
    // List is always empty in this build because nothing is treated as banned.
